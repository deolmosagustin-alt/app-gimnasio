...
export const EXERCISE_LIBRARY = [
  ...
  // Glúteo y cadera
  { id: "sentadilla_bulgara", name: "Sentadilla Búlgara (énfasis glúteo)", muscle: "Glúteo", group: "gluteo", secondary: [{ group: "cuadriceps", weight: 0.3 }, { group: "femoral", weight: 0.2 }], nota: "Torso inclinado ~30° adelante: el trabajo va al glúteo.", videoQuery: "sentadilla búlgara técnica glúteo" },
  ...
  { id: "paseo_granjero", name: "Paseo del Granjero", muscle: "Trapecio / Agarre", group: "trapecio", secondary: [{ group: "antebrazos", weight: 0.5 }, { group: "core", weight: 0.2 }], nota: "Torso erguido, hombros atrás.", videoQuery: "paseo del granjero técnica farmers walk" },
  ...
  { id: "sentadilla_frontal", name: "Sentadilla Frontal", muscle: "Cuádriceps", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.3 }, { group: "core", weight: 0.2 }], nota: "Barra apoyada adelante en los hombros.", videoQuery: "sentadilla frontal técnica front squat" },
  ...
  { id: "lenador_polea", name: "Leñador en Polea", muscle: "Core / oblicuos", group: "core", secondary: [{ group: "deltoide_anterior", weight: 0.15 }], nota: "Movimiento diagonal de arriba a abajo (o viceversa).", videoQuery: "leñador polea técnica core woodchopper" },
