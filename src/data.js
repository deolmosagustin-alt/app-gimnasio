...
export const EXERCISE_LIBRARY = [
  ...
  { id: "press_militar_mancuernas", name: "Press Militar con Mancuernas", muscle: "Deltoides ant.", group: "deltoide_anterior", loadFactor: 2, secondary: [{ group: "triceps", weight: 0.3, alwaysCount: true }, { group: "trapecio", weight: 0.15 }], nota: "Mayor rango y estabilidad que con barra.", videoQuery: "press militar mancuernas técnica" },
  { id: "press_arnold", name: "Press Arnold", muscle: "Deltoides ant. / lateral", group: "deltoide_anterior", loadFactor: 2, secondary: [{ group: "deltoide_lateral", weight: 0.3 }, { group: "triceps", weight: 0.25, alwaysCount: true }], nota: "La rotación de muñeca suma trabajo del deltoides lateral.", videoQuery: "press arnold técnica hombros" },
  ...
  { id: "press_banca_mancuernas_neutro", name: "Press Banca con Mancuernas Agarre Neutro", muscle: "Pectoral", group: "pectoral_medio", loadFactor: 2, secondary: [{ group: "triceps", weight: 0.3, alwaysCount: true }, { group: "deltoide_anterior", weight: 0.3 }], nota: "Palmas enfrentadas: menos estrés en el hombro.", videoQuery: "press banca mancuernas agarre neutro técnica" },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  // TANDA 2 — MANCUERNAS A FONDO
  // Variantes de mancuerna para prácticamente todo lo que se pueda hacer con
  // ellas, incluidas versiones con énfasis distinto (glúteo vs cuádriceps),
  // agarres alternativos y unilaterales. loadFactor: 2 en todo lo que use DOS
  // mancuernas; los unilaterales van sin loadFactor (el peso ya es el del lado).
  // ═══════════════════════════════════════════════════════════════════════

  // ---- Piernas: cuádriceps y glúteo con mancuernas ----
  { id: "sentadilla_mancuernas_hombros", name: "Sentadilla con Mancuernas en Hombros", muscle: "Cuádriceps", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.35 }, { group: "core", weight: 0.2 }, { group: "espalda_baja", weight: 0.15 }], loadFactor: 2, nota: "Mancuernas apoyadas sobre los hombros como si fuera una barra. Torso más erguido que con barra.", videoQuery: "sentadilla con mancuernas en hombros técnica" },
  { id: "sentadilla_mancuernas_costados", name: "Sentadilla con Mancuernas a los Costados", muscle: "Cuádriceps", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.3 }, { group: "antebrazos", weight: 0.25 }, { group: "trapecio", weight: 0.15 }], loadFactor: 2, nota: "Mancuernas colgando a los lados. Simple y directo; el agarre suele ser el límite.", videoQuery: "sentadilla con mancuernas a los costados técnica" },
  { id: "sentadilla_bulgara_gluteo_mancuernas", name: "Búlgara con Énfasis en Glúteo (Mancuernas)", muscle: "Glúteo", group: "gluteo", secondary: [{ group: "cuadriceps", weight: 0.3 }, { group: "femoral", weight: 0.3 }, { group: "aductores", weight: 0.15 }], loadFactor: 2, nota: "Pie adelantado MÁS lejos y torso inclinado al frente: el glúteo se lleva casi todo.", videoQuery: "búlgara énfasis glúteo mancuernas técnica" },
  { id: "sentadilla_bulgara_cuadriceps_mancuernas", name: "Búlgara con Énfasis en Cuádriceps (Mancuernas)", muscle: "Cuádriceps", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.25 }, { group: "femoral", weight: 0.12 }], loadFactor: 2, nota: "Pie adelantado MÁS cerca y torso vertical: la rodilla viaja hacia adelante y el cuádriceps manda.", videoQuery: "búlgara énfasis cuádriceps mancuernas técnica" },
  { id: "zancada_atras_mancuernas", name: "Zancada Hacia Atrás con Mancuernas", muscle: "Glúteo / Cuádriceps", group: "gluteo", secondary: [{ group: "cuadriceps", weight: 0.35 }, { group: "femoral", weight: 0.2 }], loadFactor: 2, nota: "El paso va hacia atrás: menos estrés de rodilla y más glúteo que la zancada clásica.", videoQuery: "zancada hacia atrás mancuernas técnica reverse lunge" },
  { id: "zancada_lateral_mancuernas", name: "Zancada Lateral con Mancuernas", muscle: "Cuádriceps / Aductores", group: "cuadriceps", secondary: [{ group: "aductores", weight: 0.4 }, { group: "gluteo", weight: 0.3 }], loadFactor: 2, nota: "Paso al costado empujando la cadera atrás; la otra pierna queda estirada.", videoQuery: "zancada lateral mancuernas técnica" },
  { id: "zancada_deficit_mancuernas", name: "Zancada con Déficit y Mancuernas", muscle: "Glúteo / Cuádriceps", group: "gluteo", secondary: [{ group: "cuadriceps", weight: 0.35 }, { group: "femoral", weight: 0.25 }], loadFactor: 2, nota: "Pie adelantado sobre un step: más rango, más estiramiento del glúteo.", videoQuery: "zancada con déficit mancuernas técnica" },
  { id: "sentadilla_goblet_pausa", name: "Sentadilla Goblet con Pausa", muscle: "Cuádriceps", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.3 }, { group: "core", weight: 0.25 }], nota: "Una mancuerna contra el pecho y 2-3 segundos abajo: técnica y movilidad.", videoQuery: "sentadilla goblet con pausa técnica" },
  { id: "sentadilla_sissy_mancuerna", name: "Sentadilla Sissy con Mancuerna", muscle: "Cuádriceps", group: "cuadriceps", nota: "Rodillas al frente y torso hacia atrás: aislamiento brutal del cuádriceps.", videoQuery: "sentadilla sissy con mancuerna técnica" },
  { id: "step_up_lateral_mancuernas", name: "Step Up Lateral con Mancuernas", muscle: "Glúteo / Cuádriceps", group: "gluteo", secondary: [{ group: "cuadriceps", weight: 0.3 }, { group: "aductores", weight: 0.2 }], loadFactor: 2, nota: "Subís al cajón de costado: pega fuerte en el glúteo medio.", videoQuery: "step up lateral mancuernas técnica" },
  { id: "step_up_alto_mancuernas", name: "Step Up Alto con Mancuernas", muscle: "Glúteo", group: "gluteo", secondary: [{ group: "cuadriceps", weight: 0.35 }, { group: "femoral", weight: 0.2 }], loadFactor: 2, nota: "Cajón por encima de la rodilla: cuanto más alto, más glúteo.", videoQuery: "step up alto mancuernas glúteo técnica" },
  { id: "sentadilla_split_mancuernas", name: "Sentadilla Split con Mancuernas", muscle: "Cuádriceps / Glúteo", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.35 }, { group: "femoral", weight: 0.15 }], loadFactor: 2, nota: "Pies fijos en tijera (sin banco): bajás y subís en el lugar.", videoQuery: "sentadilla split mancuernas técnica" },
  { id: "sentadilla_frontal_mancuernas", name: "Sentadilla Frontal con Mancuernas", muscle: "Cuádriceps", group: "cuadriceps", secondary: [{ group: "gluteo", weight: 0.3 }, { group: "core", weight: 0.3 }], loadFactor: 2, nota: "Mancuernas al frente a la altura de los hombros: torso muy vertical.", videoQuery: "sentadilla frontal mancuernas técnica" },
  { id: "hip_thrust_mancuernas_una_pierna", name: "Hip Thrust a Una Pierna con Mancuerna", muscle: "Glúteo", group: "gluteo", secondary: [{ group: "femoral", weight: 0.3 }], nota: "Una pierna en el aire y la mancuerna en la cadera: unilateral y muy exigente.", videoQuery: "hip thrust una pierna mancuerna técnica" },
  { id: "peso_muerto_sumo_mancuerna", name: "Peso Muerto Sumo con Mancuerna", muscle: "Glúteo / Aductores", group: "gluteo", secondary: [{ group: "aductores", weight: 0.35 }, { group: "cuadriceps", weight: 0.25 }, { group: "femoral", weight: 0.3 }, { group: "espalda_baja", weight: 0.25 }], nota: "Postura ancha, una mancuerna entre las piernas. Mucho glúteo y aductor.", videoQuery: "peso muerto sumo mancuerna técnica" },
  { id: "peso_muerto_rumano_una_pierna_mancuernas", name: "Peso Muerto Rumano a Una Pierna con Mancuernas", muscle: "Femoral / Glúteo", group: "femoral", secondary: [{ group: "gluteo", weight: 0.45 }, { group: "core", weight: 0.25 }, { group: "espalda_baja", weight: 0.25 }], loadFactor: 2, nota: "Una mancuerna en cada mano, pierna libre extendida atrás: equilibrio y femoral.", videoQuery: "peso muerto rumano una pierna mancuernas técnica" },
  { id: "curl_femoral_mancuerna_pie", name: "Curl Femoral con Mancuerna (de Pie)", muscle: "Femoral", group: "femoral", nota: "Sujetá la mancuerna entre los pies y flexioná la rodilla. Alternativa casera.", videoQuery: "curl femoral con mancuerna técnica" },
  { id: "elevacion_talones_una_pierna_mancuerna", name: "Elevación de Talones a Una Pierna con Mancuerna", muscle: "Pantorrillas", group: "pantorrillas", nota: "Una mancuerna del lado que trabaja, sostenete con la otra mano. Rango completo.", videoQuery: "elevación talones una pierna mancuerna técnica" },
  { id: "sentadilla_cossack_mancuerna", name: "Sentadilla Cossack con Mancuerna", muscle: "Aductores / Cuádriceps", group: "aductores", secondary: [{ group: "cuadriceps", weight: 0.35 }, { group: "gluteo", weight: 0.3 }], nota: "Una mancuerna al pecho, bajás de un lado con la otra pierna estirada.", videoQuery: "sentadilla cossack mancuerna técnica" },

  // ---- Pecho con mancuernas ----
  { id: "press_mancuernas_agarre_neutro_inclinado", name: "Press Inclinado Agarre Neutro con Mancuernas", muscle: "Pectoral sup.", group: "pectoral_superior", secondary: [{ group: "triceps", weight: 0.35, alwaysCount: true }, { group: "deltoide_anterior", weight: 0.3 }], loadFactor: 2, nota: "Palmas enfrentadas: mucho más amigable para el hombro.", videoQuery: "press inclinado agarre neutro mancuernas técnica" },
  { id: "aperturas_press_mancuernas", name: "Apertura-Press con Mancuernas", muscle: "Pectoral", group: "pectoral_medio", secondary: [{ group: "triceps", weight: 0.2, alwaysCount: true }], loadFactor: 2, nota: "Híbrido: abrís como apertura y cerrás empujando como press.", videoQuery: "apertura press mancuernas técnica squeeze press" },
  { id: "press_squeeze_mancuernas", name: "Squeeze Press con Mancuernas", muscle: "Pectoral", group: "pectoral_medio", secondary: [{ group: "triceps", weight: 0.35, alwaysCount: true }], loadFactor: 2, nota: "Las mancuernas se aprietan una contra otra durante todo el movimiento.", videoQuery: "squeeze press mancuernas técnica" },
  { id: "press_mancuernas_una_mano", name: "Press de Pecho a Una Mano con Mancuerna", muscle: "Pectoral", group: "pectoral_medio", secondary: [{ group: "core", weight: 0.35 }, { group: "oblicuos", weight: 0.3 }, { group: "triceps", weight: 0.3, alwaysCount: true }], nota: "Unilateral: el core trabaja fuerte para que no te tuerza el torso.", videoQuery: "press de pecho una mano mancuerna técnica" },
  { id: "aperturas_declinadas_una_mano", name: "Apertura a Una Mano con Mancuerna", muscle: "Pectoral", group: "pectoral_medio", nota: "Aislás un lado por vez; ideal para corregir asimetrías del pecho.", videoQuery: "apertura una mano mancuerna técnica" },

  // ---- Espalda con mancuernas ----
  { id: "remo_mancuerna_agarre_supino", name: "Remo con Mancuerna Agarre Supino", muscle: "Dorsal", group: "dorsales", secondary: [{ group: "biceps", weight: 0.4 }, { group: "trapecio", weight: 0.2 }], nota: "Palma hacia adelante: más bíceps y dorsal bajo.", videoQuery: "remo mancuerna agarre supino técnica" },
  { id: "remo_mancuernas_prono", name: "Remo con Mancuernas Agarre Prono", muscle: "Dorsal medio / Post.", group: "dorsales", secondary: [{ group: "deltoide_posterior", weight: 0.35 }, { group: "trapecio", weight: 0.3 }, { group: "biceps", weight: 0.2 }], loadFactor: 2, nota: "Palmas hacia abajo y codos abiertos: mucho trapecio medio y deltoide posterior.", videoQuery: "remo mancuernas agarre prono técnica" },
  { id: "remo_mancuerna_banco", name: "Remo con Mancuerna Apoyado en Banco", muscle: "Dorsal", group: "dorsales", secondary: [{ group: "biceps", weight: 0.3 }, { group: "trapecio", weight: 0.25 }, { group: "antebrazos", weight: 0.2 }], nota: "Rodilla y mano en el banco: la clásica; espalda paralela al piso.", videoQuery: "remo con mancuerna apoyado en banco técnica" },
  { id: "pullover_mancuerna_dorsal", name: "Pullover con Mancuerna (énfasis dorsal)", muscle: "Dorsal", group: "dorsales", secondary: [{ group: "pectoral_medio", weight: 0.3 }, { group: "triceps", weight: 0.25, alwaysCount: true }, { group: "core", weight: 0.2 }], nota: "Codos más abiertos y cadera baja: el dorsal se lleva el trabajo.", videoQuery: "pullover mancuerna dorsal técnica" },
  { id: "renegade_row", name: "Renegade Row", muscle: "Dorsal / Core", group: "dorsales", secondary: [{ group: "core", weight: 0.45 }, { group: "oblicuos", weight: 0.35 }, { group: "biceps", weight: 0.25 }], nota: "En plancha sobre las mancuernas, remás una por vez sin girar la cadera.", videoQuery: "renegade row técnica" },
  { id: "encogimientos_mancuernas_pausa", name: "Encogimientos con Mancuernas y Pausa", muscle: "Trapecio", group: "trapecio", secondary: [{ group: "antebrazos", weight: 0.3 }], loadFactor: 2, nota: "2 segundos de contracción arriba: el trapecio se entera de verdad.", videoQuery: "encogimientos mancuernas con pausa técnica" },
  { id: "high_pull_mancuernas", name: "High Pull con Mancuernas", muscle: "Trapecio / Deltoides", group: "trapecio", secondary: [{ group: "deltoide_lateral", weight: 0.35 }, { group: "deltoide_posterior", weight: 0.25 }, { group: "biceps", weight: 0.15 }], loadFactor: 2, nota: "Tirón explosivo hasta el pecho con codos altos.", videoQuery: "high pull mancuernas técnica" },

  // ---- Hombros con mancuernas ----
  { id: "press_militar_una_mano_mancuerna", name: "Press Militar a Una Mano con Mancuerna", muscle: "Deltoides ant.", group: "deltoide_anterior", secondary: [{ group: "core", weight: 0.35 }, { group: "oblicuos", weight: 0.3 }, { group: "triceps", weight: 0.3, alwaysCount: true }], nota: "De pie y unilateral: el core tiene que frenar la inclinación lateral.", videoQuery: "press militar una mano mancuerna técnica" },
  { id: "press_hombro_neutro_mancuernas", name: "Press de Hombro Agarre Neutro con Mancuernas", muscle: "Deltoides ant.", group: "deltoide_anterior", secondary: [{ group: "triceps", weight: 0.3, alwaysCount: true }, { group: "deltoide_lateral", weight: 0.25 }], loadFactor: 2, nota: "Palmas enfrentadas todo el recorrido: hombro mucho más cómodo.", videoQuery: "press hombro agarre neutro mancuernas técnica" },
  { id: "elevaciones_laterales_sentado", name: "Elevaciones Laterales Sentado", muscle: "Deltoides lateral", group: "deltoide_lateral", loadFactor: 2, nota: "Sentado no podés impulsar con las piernas: el deltoide hace todo.", videoQuery: "elevaciones laterales sentado mancuernas técnica" },
  { id: "elevaciones_laterales_parciales", name: "Elevaciones Laterales Parciales (Lateral Raise 21s)", muscle: "Deltoides lateral", group: "deltoide_lateral", loadFactor: 2, nota: "Parciales abajo, parciales arriba y completas: quema garantizada.", videoQuery: "elevaciones laterales parciales técnica" },
  { id: "elevaciones_laterales_pausa", name: "Elevaciones Laterales con Pausa Arriba", muscle: "Deltoides lateral", group: "deltoide_lateral", loadFactor: 2, nota: "2 segundos arriba con los meñiques apenas más altos que los pulgares.", videoQuery: "elevaciones laterales con pausa técnica" },
  { id: "elevaciones_frontales_alternadas", name: "Elevaciones Frontales Alternadas", muscle: "Deltoides ant.", group: "deltoide_anterior", nota: "Un brazo por vez hasta la altura del hombro, sin balanceo.", videoQuery: "elevaciones frontales alternadas mancuernas técnica" },
  { id: "elevaciones_frontales_neutro", name: "Elevaciones Frontales Agarre Neutro", muscle: "Deltoides ant.", group: "deltoide_anterior", loadFactor: 2, nota: "Palmas enfrentadas: reparte mejor entre deltoide anterior y lateral.", videoQuery: "elevaciones frontales agarre neutro técnica" },
  { id: "pajaro_sentado_mancuernas", name: "Pájaro Sentado con Mancuernas", muscle: "Deltoides post.", group: "deltoide_posterior", secondary: [{ group: "trapecio", weight: 0.25 }], loadFactor: 2, nota: "Sentado con el torso sobre los muslos: aísla el posterior sin usar la lumbar.", videoQuery: "pájaro sentado mancuernas técnica" },
  { id: "pajaro_pecho_apoyado", name: "Pájaro con Pecho Apoyado", muscle: "Deltoides post.", group: "deltoide_posterior", secondary: [{ group: "trapecio", weight: 0.3 }], loadFactor: 2, nota: "Banco inclinado a 30-45°: cero trampa, todo deltoide posterior.", videoQuery: "pájaro pecho apoyado mancuernas técnica" },
  { id: "press_arnold_una_mano", name: "Press Arnold a Una Mano", muscle: "Deltoides", group: "deltoide_anterior", secondary: [{ group: "deltoide_lateral", weight: 0.35 }, { group: "triceps", weight: 0.25, alwaysCount: true }], nota: "La rotación del Arnold pero unilateral: mucho control.", videoQuery: "press arnold una mano técnica" },
  { id: "y_raise_mancuernas", name: "Y-Raise con Mancuernas", muscle: "Deltoides / Trapecio", group: "deltoide_posterior", secondary: [{ group: "trapecio", weight: 0.4 }, { group: "deltoide_lateral", weight: 0.2 }], loadFactor: 2, nota: "Pecho apoyado en banco inclinado, brazos formando una Y. Trapecio inferior.", videoQuery: "y raise mancuernas técnica" },
  { id: "l_raise_mancuernas", name: "Elevación en L con Mancuernas", muscle: "Manguito rotador", group: "deltoide_posterior", loadFactor: 2, nota: "Codos a 90° pegados al torso, rotás hacia afuera. Salud del hombro.", videoQuery: "rotación externa mancuernas técnica" },

  // ---- Bíceps con mancuernas ----
  { id: "curl_alternado_mancuernas", name: "Curl Alternado con Mancuernas", muscle: "Bíceps", group: "biceps", nota: "Un brazo por vez: podés concentrarte mejor en cada contracción.", videoQuery: "curl alternado mancuernas técnica" },
  { id: "curl_supinacion_mancuernas", name: "Curl con Supinación", muscle: "Bíceps", group: "biceps", nota: "Empezás en neutro y girás la muñeca al subir: máxima activación del bíceps.", videoQuery: "curl con supinación mancuernas técnica" },
  { id: "curl_inclinado_alternado", name: "Curl Inclinado Alternado", muscle: "Bíceps", group: "biceps", nota: "Banco a 45°, un brazo por vez con el brazo colgando atrás: estiramiento máximo.", videoQuery: "curl inclinado alternado mancuernas técnica" },
  { id: "curl_martillo_sentado", name: "Curl Martillo Sentado", muscle: "Bíceps / braquial", group: "biceps", secondary: [{ group: "antebrazos", weight: 0.3 }], loadFactor: 2, nota: "Sentado, sin impulso de cadera: braquial y braquiorradial puros.", videoQuery: "curl martillo sentado mancuernas técnica" },
  { id: "curl_drag", name: "Drag Curl con Mancuernas", muscle: "Bíceps", group: "biceps", loadFactor: 2, nota: "Los codos van hacia atrás mientras subís, la mancuerna roza el torso.", videoQuery: "drag curl mancuernas técnica" },
  { id: "curl_concentrado_pausa", name: "Curl Concentrado con Pausa", muscle: "Bíceps", group: "biceps", nota: "Codo apoyado en el muslo, 2 segundos de contracción arriba.", videoQuery: "curl concentrado con pausa técnica" },
  { id: "curl_araña_mancuernas", name: "Curl Araña con Mancuernas", muscle: "Bíceps", group: "biceps", loadFactor: 2, nota: "Boca abajo sobre banco inclinado: cero impulso, pico de contracción brutal.", videoQuery: "curl araña mancuernas técnica spider curl" },

  // ---- Tríceps con mancuernas ----
  { id: "extension_triceps_sentado_mancuerna", name: "Extensión de Tríceps Sentado con Mancuerna", muscle: "Tríceps", group: "triceps", nota: "Una mancuerna con las dos manos por detrás de la cabeza. Cabeza larga del tríceps.", videoQuery: "extensión tríceps sentado mancuerna técnica" },
  { id: "patada_triceps_mancuerna_doble", name: "Patada de Tríceps con Mancuernas", muscle: "Tríceps", group: "triceps", loadFactor: 2, nota: "Ambos brazos a la vez, torso a 45° y codos bien altos y fijos.", videoQuery: "patada tríceps mancuernas doble técnica" },
  { id: "press_triceps_cerrado_mancuernas", name: "Press Cerrado con Mancuernas", muscle: "Tríceps", group: "triceps", secondary: [{ group: "pectoral_medio", weight: 0.3 }], loadFactor: 2, nota: "Mancuernas juntas sobre el pecho, codos pegados al torso.", videoQuery: "press cerrado mancuernas tríceps técnica" },
  { id: "tate_press", name: "Tate Press", muscle: "Tríceps", group: "triceps", loadFactor: 2, nota: "Acostado, bajás las mancuernas hacia el pecho girando los codos hacia afuera.", videoQuery: "tate press técnica tríceps" },
  { id: "extension_triceps_inclinado", name: "Extensión de Tríceps en Banco Inclinado", muscle: "Tríceps", group: "triceps", loadFactor: 2, nota: "Banco a 45° boca arriba: más estiramiento de la cabeza larga.", videoQuery: "extensión tríceps banco inclinado mancuernas técnica" },

  // ---- Core y antebrazo con mancuernas ----
  { id: "russian_twist_mancuerna", name: "Russian Twist con Mancuerna", muscle: "Oblicuos", group: "oblicuos", secondary: [{ group: "core", weight: 0.35 }], nota: "Sentado con los pies elevados, girá con la mancuerna tocando a los costados.", videoQuery: "russian twist con mancuerna técnica" },
  { id: "woodchopper_mancuerna", name: "Leñador con Mancuerna", muscle: "Oblicuos", group: "oblicuos", secondary: [{ group: "core", weight: 0.35 }, { group: "deltoide_anterior", weight: 0.15 }], nota: "Movimiento diagonal de arriba a abajo cruzando el cuerpo.", videoQuery: "woodchopper mancuerna técnica leñador" },
  { id: "suitcase_carry", name: "Suitcase Carry", muscle: "Oblicuos / Agarre", group: "oblicuos", secondary: [{ group: "core", weight: 0.4 }, { group: "antebrazos", weight: 0.4 }, { group: "trapecio", weight: 0.25 }], nota: "Caminás con UNA mancuerna al costado sin inclinarte: oblicuo antirrotación.", videoQuery: "suitcase carry técnica" },
  { id: "farmer_walk_mancuernas", name: "Farmer Walk con Mancuernas", muscle: "Agarre / Core", group: "antebrazos", secondary: [{ group: "trapecio", weight: 0.35 }, { group: "core", weight: 0.3 }, { group: "gluteo", weight: 0.15 }], loadFactor: 2, nota: "Caminá con las dos mancuernas lo más lejos posible. Agarre, core y postura.", videoQuery: "farmer walk mancuernas técnica" },
  { id: "sit_up_mancuerna", name: "Sit Up con Mancuerna", muscle: "Core", group: "core", nota: "Mancuerna contra el pecho o extendida arriba para sumar carga.", videoQuery: "sit up con mancuerna técnica" },
  { id: "plancha_remo_mancuernas", name: "Plancha con Remo", muscle: "Core / Dorsal", group: "core", secondary: [{ group: "dorsales", weight: 0.4 }, { group: "oblicuos", weight: 0.35 }], nota: "En plancha, remás una mancuerna por vez sin que se mueva la cadera.", videoQuery: "plancha con remo mancuernas técnica" },
  { id: "curl_muneca_inverso_mancuernas", name: "Curl de Muñeca Inverso con Mancuernas", muscle: "Antebrazo (extensores)", group: "antebrazos", loadFactor: 2, nota: "Palmas hacia abajo: trabaja los extensores, clave para equilibrar el antebrazo.", videoQuery: "curl muñeca inverso mancuernas técnica" },
];
